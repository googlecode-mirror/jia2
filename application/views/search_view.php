	...
	<div id="search_result_01" class="search_result">
		...
		<ul id="user-result">
			...
			<li>
				...
				?>
				<div class="li_mbox">
					<h3><?=anchor('personal/profile/' . $row['id'], $row['name'])
					?></h3>
				</div>
		...
		<ul id="corporation-result">
			...
			<li>
				...
				?>
				<div class="li_mbox">
					<h3><?=anchor('corporation/profile/' . $row['id'], $row['name'])
					?></h3>
				</div>
			</li>
			<? endforeach?>

...
REPLACE INTO `activity` (`id`, `user_id`, `corporation_id`, `name`, `start_time`, `deadline`, `address`, `comment`) VALUES
...
-- Dumping data for table jia2.comment: ~96 rows (approximately)
...
-- Dumping data for table jia2.notify: ~11 rows (approximately)
...
-- Dumping data for table jia2.post: ~29 rows (approximately)
...
REPLACE INTO `user` (`id`, `name`, `email`, `pass`, `type_id`, `school_id`, `province_id`, `avatar`, `gender`) VALUES
	...
	(11, '张晖', 'rabbitzhang52@qq.com', 'e18d959268ead9d3caf501969715e3d0', 1, NULL, NULL, '11.jpg', 1),

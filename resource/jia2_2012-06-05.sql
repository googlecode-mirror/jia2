...
INSERT INTO `activity` (`id`, `user_id`, `corporation_id`, `name`, `time`, `start_time`, `deadline`, `address`, `detail`)
VALUES
...
# Dump of table corporation_request
# ------------------------------------------------------------

DROP TABLE IF EXISTS `corporation_request`;

CREATE TABLE `corporation_request` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `notify` (`id`, `user_id`, `receiver_id`, `type_id`, `time`, `content`, `status`)
VALUES
...
INSERT INTO `post_meta` (`id`, `post_id`, `meta_table`, `meta_key`, `meta_value`)
VALUES
...
LOCK TABLES `ps_region` WRITE;
/*!40000 ALTER TABLE `ps_region` DISABLE KEYS */;

INSERT INTO `ps_region` (`region_id`, `parent_id`, `region_name`, `region_type`)
VALUES
	(1,0,'中国',0),
	(2,1,'北京',1),
	(3,1,'安徽',1),
